...
class $ExperimentsTable extends Experiments
  ...
  static const VerificationMeta _successRatingMeta = const VerificationMeta(
    'successRating',
  );
  @override
  late final GeneratedColumn<int> successRating = GeneratedColumn<int>(
    'success_rating',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('success_rating')) {
      context.handle(
        _successRatingMeta,
        successRating.isAcceptableOrUnknown(
          data['success_rating']!,
          _successRatingMeta,
        ),
      );
  ...
  Experiment map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Experiment(
      ...
      successRating: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}success_rating'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class Experiment extends DataClass implements Insertable<Experiment> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || successRating != null) {
      map['success_rating'] = Variable<int>(successRating);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    return map;
  }
  ...
  ExperimentsCompanion toCompanion(bool nullToAbsent) {
    return ExperimentsCompanion(
      ...
      conclusion: conclusion == null && nullToAbsent
          ? const Value.absent()
          : Value(conclusion),
      successRating: successRating == null && nullToAbsent
          ? const Value.absent()
          : Value(successRating),
      createdAt: Value(createdAt),
    );
  ...
  factory Experiment.fromJson(
    ...
    return Experiment(
      ...
      successRating: serializer.fromJson<int?>(json['successRating']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'successRating': serializer.toJson<int?>(successRating),
      'createdAt': serializer.toJson<DateTime>(createdAt),
    };
  }
  ...
  Experiment copyWith({
    ...
    Value<int?> successRating = const Value.absent(),
    DateTime? createdAt,
  }) => Experiment(
    id: id ?? this.id,
    name: name ?? this.name,
    ...
    successRating: successRating.present
        ? successRating.value
        : this.successRating,
    createdAt: createdAt ?? this.createdAt,
  );
  Experiment copyWithCompanion(ExperimentsCompanion data) {
    return Experiment(
      ...
      conclusion: data.conclusion.present
          ...
          : this.conclusion,
      successRating: data.successRating.present
          ? data.successRating.value
          : this.successRating,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
    );
  }
  ...
  String toString() {
    return (StringBuffer('Experiment(')
          ...
          ..write('successRating: $successRating, ')
          ..write('createdAt: $createdAt')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is Experiment &&
          ...
          other.successRating == this.successRating &&
          other.createdAt == this.createdAt);
}
...
class ExperimentsCompanion extends UpdateCompanion<Experiment> {
  ...
  const ExperimentsCompanion({
    ...
    this.successRating = const Value.absent(),
    this.createdAt = const Value.absent(),
  });
  ...
  static Insertable<Experiment> custom({
    ...
    return RawValuesInsertable({
      ...
      if (successRating != null) 'success_rating': successRating,
      if (createdAt != null) 'created_at': createdAt,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (successRating.present) {
      map['success_rating'] = Variable<int>(successRating.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final ExperimentsDao experimentsDao = ExperimentsDao(
    this as AppDatabase,
  );
  @override
...
class $$ExperimentsTableFilterComposer
  ...
  ColumnFilters<int> get successRating => $composableBuilder(
    column: $table.successRating,
    builder: (column) => ColumnFilters(column),
  );
...
class $$ExperimentsTableOrderingComposer
  ...
  ColumnOrderings<int> get successRating => $composableBuilder(
    column: $table.successRating,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$ExperimentsTableAnnotationComposer
  ...
  GeneratedColumn<int> get successRating => $composableBuilder(
    column: $table.successRating,
    builder: (column) => column,
  );
...
class $$ExperimentsTableTableManager
    extends
        RootTableManager<
          ...
          (
            Experiment,
            BaseReferences<_$AppDatabase, $ExperimentsTable, Experiment>,
          ),
          Experiment,
          PrefetchHooks Function()
        > {
